...
aria-label="Construction site timelapse video showing building progress"
      ...
      {/* Image Slider - positioned at 65% from the top */}
      <div className="absolute left-0 right-0 z-30" style={{ top: "60%" }}>
      ...
      {/* Content */}
      <div className="relative z-20 container mx-auto px-4 h-full flex flex-col" style={{ paddingTop: "25%" }}>
